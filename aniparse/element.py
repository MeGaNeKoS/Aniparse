...
class ElementCategory(enum.Enum):
    ...
    def is_searchable(cls, category: 'ElementCategory') -> bool:
        """
        Check if the given element category is searchable.

        :param category: The element category to check.
        :return: True if the category is searchable, False otherwise.
        """
